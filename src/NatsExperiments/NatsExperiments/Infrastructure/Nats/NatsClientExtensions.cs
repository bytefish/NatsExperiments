...
using NatsExperiments.Infrastructure.Health;

namespace NatsExperiments.Infrastructure.Nats
{
    public static class NatsClientExtensions
    {
        private const string DefaultConfigSectionName = "NATS:Net";
        ...
        public static void AddNatsClient(this IHostApplicationBuilder builder, string connectionName, Action<NatsClientSettings>? configureSettings = null, Func<NatsOpts, NatsOpts>? configureOptions = null)
            => builder.AddNatsClient(configurationSectionName: DefaultConfigSectionName, connectionName: connectionName, serviceKey: null, configureSettings: configureSettings, configureOptions: configureOptions);
        ...
        public static void AddKeyedNatsClient(this IHostApplicationBuilder builder, string name, Action<NatsClientSettings>? configureSettings = null, Func<NatsOpts, NatsOpts>? configureOptions = null)
        {
            ...
            builder.AddNatsClient(configurationSectionName: $"{DefaultConfigSectionName}:{name}", connectionName: name, serviceKey: name, configureSettings: configureSettings, configureOptions: configureOptions);
        }
        ...
        private static void AddNatsClient(this IHostApplicationBuilder builder, string configurationSectionName, string connectionName, object? serviceKey, Action<NatsClientSettings>? configureSettings, Func<NatsOpts, NatsOpts>? configureOptions)
        {
            ...
            {
                builder.Services.TryAddKeyedSingleton(serviceKey, (provider, _) => Factory(provider));
